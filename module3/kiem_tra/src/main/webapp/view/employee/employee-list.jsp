        ...
        <div class="mx-auto ">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="tableList">
                    ...
                    <c:forEach var="employee"  items='${list}' varStatus="count">
                        <tr>
                            ...
                            <td class="td-actions text-right">
                                ...
                                <a href="/employees?action=view&id=${employee.id}" class="text-light">
                                ...
                                <a href="/employees?action=edit&id=${employee.id} " class="text-light">
                                    <button type="button" rel="tooltip"
                                ...
                                <a data-href="/employees?action=delete&id=${employee.id}"
                                   data-record-title="${employee.name}"
