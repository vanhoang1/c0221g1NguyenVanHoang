...
public class BlogController {
    ...
    @GetMapping("/search")
    public ModelAndView searchByTitle(@PageableDefault(value = 5) Pageable pageable, @RequestParam String title ){
        return  new  ModelAndView("/blog/index","blogList",blogService.findAllByTitle(title,pageable)).addObject("search",title);
    }
